...
class MyFrameTaxi extends JFrame implements ActionListener{
	...
	private JButton b2=new JButton("At_Destination"); private JButton b3=new JButton("Exit");

	private JPanel p1=new JPanel();
	
	private Solutions.Taxi t =new Solutions.Taxi("999123", "John Shine",  7);
	...
	public MyFrameTaxi(String s){
        ...
        refresh();
		setSize(280,300);    setVisible(true);}
